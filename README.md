...
|---| ----- | -------- | ---------- | --- |
|28|[Implement Strstr](https://leetcode.com/problems/implement-strstr/)| [C++](./cpp/28.ImplementstrStr().cpp) [Java](./java/28.ImplementstrStr().java) [Python](./py/28.ImplementstrStr().py)|Easy|[Doc](./doc/28.ImplementstrStr().md)
